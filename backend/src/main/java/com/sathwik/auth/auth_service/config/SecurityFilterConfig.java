...
@Configuration // this annotation tells the spring container that the class contains methods annotated with @Bean
@EnableWebSecurity // used to enable web based security at the http level
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    config.setAllowedOrigins(List.of("https://todo-frontend-44556.web.app","http://localhost:5173"));
